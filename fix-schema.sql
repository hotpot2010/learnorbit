...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Added is_creator column to user table';
    ELSE
        RAISE NOTICE 'is_creator column already exists';
    END IF;
END $$;
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Added course_id foreign key constraint';
    END IF;
...
-- Schema fix completed! Check the results above.
