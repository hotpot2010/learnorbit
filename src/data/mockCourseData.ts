...
export const mockCourseData: CourseStep[] = [
  {
    ...
    description: 'Learn core concepts: agents, environments, states, actions, and rewards',
    status: 'completed',
        ...
        questions: [
          {
            ...
            explanation: 'The agent aims to learn a policy that maximizes the expected cumulative reward.'
          },
          {
            id: 'q2',
            ...
            explanation: 'RL learns from rewards, not supervised labels like in supervised learning.'
          }
        ]
      }
    }
  },
  {
    ...
    description: 'Deep dive into Q-Learning mathematical foundations and update rules',
    status: 'completed',
        ...
        questions: [
          {
            ...
            explanation: 'Q(s,a) estimates the expected cumulative reward starting from state s, taking action a.'
          },
          {
            id: 'q4',
            ...
            explanation: 'Alpha determines how quickly the Q-values are updated with new experiences.'
          }
        ]
      }
    }
  },
  {
    ...
    exercise: {
      ...
      content: {
        ...
        description: 'Complete the Q-value update function using the Bellman equation',
...
def update_q_table(Q, state, action, reward, next_state, alpha, gamma):
    ...
    return Q`,
        testCases: [
          {
            input: 'Q=[[0,0],[0,0]], state=0, action=0, reward=1, next_state=1, alpha=0.1, gamma=0.9',
            expectedOutput: 'Q[0][0] = 0.1'
          },
          {
            input: 'Q=[[0.5,0.3],[0.2,0.8]], state=0, action=1, reward=2, next_state=1, alpha=0.2, gamma=0.8',
  ...
  },
  {
    ...
    description: 'Create a maze environment for the agent to navigate and learn',
    status: 'pending',
    estimatedTime: '3 hours',
    type: 'practice',
    difficulty: 'medium',
    ...
    exercise: {
      ...
      content: {
        ...
        description: 'Implement a grid world environment with obstacles, goals, and rewards',
  ...
  },
  {
    ...
    description: 'Train the Q-learning agent to find optimal paths in the maze environment',
    status: 'pending',
    estimatedTime: '4 hours',
    type: 'practice',
    difficulty: 'hard',
    ...
    exercise: {
      ...
      content: {
        ...
        description: 'Create a complete training loop with epsilon-greedy exploration',
  ...
  },
  {
    ...
    description: 'Create visualizations to demonstrate the learning process and final policy',
    status: 'pending',
    estimatedTime: '2 hours',
    type: 'practice',
    difficulty: 'easy',
        ...
        questions: [
          {
            ...
            explanation: 'Q-value heatmaps show which actions the agent considers most valuable in each state.'
          },
          {
            id: 'q6',
            question: 'Why is it important to plot reward over episodes during training?',
            type: 'choice',
            options: [
            ...
            correctAnswer: 'To monitor learning progress and detect convergence',
            explanation: 'Reward curves help identify when the agent has learned an optimal policy and training can stop.'
          }
        ]
      }
    }
