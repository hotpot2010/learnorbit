...
${subtitle}`;
  ...
  // 构建操作说明部分（可折叠）
  const instructionsContent = `## 📚 ${t('contentTitle')}
    ...
    <div className="learning-content-area space-y-8">
      ...
      <div className="flex justify-center">
        <Button
          ...
          variant="outline"
          className="flex items-center gap-2 transform -rotate-1 hover:rotate-0 transition-all duration-200 border-2 border-blue-200 hover:border-blue-300 bg-blue-50 hover:bg-blue-100"
          style={{
            fontFamily: '"Comic Sans MS", "Marker Felt", "Kalam", cursive'
          }}
        >
          ...
          <span className="text-blue-700 font-bold">
            {isInstructionsExpanded ? t('hideInstructions') : t('showInstructions')}
          </span>
