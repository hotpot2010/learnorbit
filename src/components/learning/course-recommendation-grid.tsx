...
const defaultCourses: Course[] = [
  {
    ...
    description: '学习Q-Learning算法和智能体训练，构建能够在环境中自主学习的AI系统',
  ...
  },
  {
    id: 'data-analysis',
    title: 'Python数据分析',
    description: '掌握pandas、numpy等数据科学核心库，学习数据清洗、分析和可视化',
  ...
  },
  {
    ...
    description: '使用React Native构建跨平台移动应用，一套代码同时支持iOS和Android',
