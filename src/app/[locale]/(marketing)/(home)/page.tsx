          ...
          <Container className="relative z-10">
            <div className="text-center space-y-6 w-full max-w-4xl mx-auto">
              ...
              <div className="space-y-4">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-800 leading-tight transform -rotate-1"
                    style={{
                ...
                {/* 手写副标题 */}
                <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto transform rotate-0.5"
                   style={{
                     fontFamily: '"Comic Sans MS", "Marker Felt", "Kalam", cursive'
                   }}>
                  {t('hero.subtitle')} 📚
